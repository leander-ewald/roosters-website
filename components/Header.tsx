...
export default function Header() {
  ...
  return (
    <>
      {/* Top Bar */}
      <div className="bg-navy-dark text-white text-xs py-1.5 hidden md:block">
        <div className="container flex justify-between items-center">
          <div className="flex gap-4">
            <a href="https://shop.iec.de/" target="_blank" rel="noopener noreferrer" className="hover:text-gold transition-colors">
              Fanshop
            </a>
            <a href="https://tickets.iec.de/" target="_blank" rel="noopener noreferrer" className="hover:text-gold transition-colors">
              Ticketshop
            </a>
          </div>
          <div className="flex gap-3">
            <a href="https://facebook.com/IserlohnRoosters/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="hover:text-gold transition-colors">
              <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
            </a>
            <a href="https://instagram.com/iserlohnroosters_official/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="hover:text-gold transition-colors">
            ...
            <a href="https://twitter.com/roosters_hockey" target="_blank" rel="noopener noreferrer" aria-label="X/Twitter" className="hover:text-gold transition-colors">
              <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            </a>
            <a href="https://youtube.com/channel/UCpXrhQmaIxM49gVAPas8S6Q" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="hover:text-gold transition-colors">
            ...
            <a href="https://tiktok.com/@iserlohn_roosters" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="hover:text-gold transition-colors">
      ...
      >
        <div className="container">
          <div className="flex items-center justify-between h-16 md:h-20">
            {/* Logo */}
            <Link href="/" className="flex-shrink-0 relative w-12 h-12 md:w-16 md:h-16">
              <Image
                src="/logo.png"
            ...
            <nav className="hidden lg:flex items-center gap-1">
              {NAV_ITEMS.map((item) => (
                ...
                >
                  <button
                    className="text-white text-sm font-semibold uppercase tracking-wider px-3 py-2 hover:text-gold transition-colors flex items-center gap-1"
                  >
                    {item.label}
                  ...
                  {openDropdown === item.label && (
                    <div className="absolute top-full left-0 bg-navy-dark border border-white/10 rounded-md shadow-xl min-w-[200px] py-2 mt-1">
        ...
        <div className="fixed inset-0 z-[100] lg:hidden">
          ...
          <div className="absolute right-0 top-0 h-full w-[300px] max-w-[85vw] bg-navy overflow-y-auto">
            ...
            <div className="p-4 flex gap-2">
              ...
              <a href="https://shop.iec.de/" target="_blank" rel="noopener noreferrer" className="btn btn-gold text-xs flex-1" onClick={closeMobile}>
                Fanshop
              </a>
            </div>
