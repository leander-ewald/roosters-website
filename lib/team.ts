...
export const ROSTER: Player[] = [
  // Torhüter
  { number: 32, name: "Hendrik Hane", position: "Torwart", nationality: "Deutschland", flag: "de", image: `${IR}/2024/08/Hane_Kachelbild_2025-480x480.jpg` },
  { number: 35, name: "Finn Becker", position: "Torwart", nationality: "Deutschland", flag: "de", image: `${IR}/2020/12/Becker_Kachelbild_2025-480x480.jpg` },
  { number: 92, name: "Andreas Jenike", position: "Torwart", nationality: "Deutschland", flag: "de", image: `${IR}/2019/05/Jenike_Kachelbild_2025-480x480.jpg` },

  // Verteidiger
  { number: 3, name: "Kyle Wood", position: "Verteidiger", nationality: "Kanada", flag: "ca", image: `${IR}/2025/08/Wood_Kachelbild_2025-480x480.jpg` },
  { number: 4, name: "Nils Elten", position: "Verteidiger", nationality: "Deutschland", flag: "de", image: `${IR}/2020/12/Elten_Kachelbild_2025-480x480.jpg` },
  { number: 7, name: "Gordejs Radionovs", position: "Verteidiger", nationality: "Deutschland", flag: "de", image: `${IR}/2025/08/Radionovs_Kachelbild_2025-480x480.jpg` },
  { number: 15, name: "Matias Lassen", position: "Verteidiger", nationality: "Dänemark", flag: "dk", image: `${IR}/2025/08/Lassen_Kachelbild_2025-480x480.jpg` },
  { number: 20, name: "Macoy Erkamps", position: "Verteidiger", nationality: "Kanada", flag: "ca", image: `${IR}/2025/08/Erkamps_Kachelbild_2025-480x480.jpg` },
  { number: 26, name: "Lua Niehus", position: "Verteidiger", nationality: "Deutschland", flag: "de", image: `${IR}/2025/11/Lua_Niehus_Kachelbild_2025-480x480.jpg` },
  { number: 55, name: "Johannes Huß", position: "Verteidiger", nationality: "Deutschland", flag: "de", image: `${IR}/2024/08/Huss_Kachelbild_2025-480x480.jpg` },
  { number: 56, name: "Robin Norell", position: "Verteidiger", nationality: "Schweden", flag: "se", image: `${IR}/2025/08/Norell_Kachelbild_2025-480x480.jpg` },
  { number: 77, name: "Colton Jobke", position: "Verteidiger", nationality: "Kanada", flag: "ca", image: `${IR}/2024/08/Jobke_Kachelbild_2025-480x480.jpg` },
  { number: 79, name: "Colin Ugbekile", position: "Verteidiger", nationality: "Deutschland", flag: "de", image: `${IR}/2022/05/Ugbekile_Kachelbild_2025-480x480.jpg` },

  // Stürmer
  { number: 8, name: "Daniel Geiger", position: "Stürmer", nationality: "Deutschland", flag: "de", image: `${IR}/2025/08/Geiger_Kachelbild_2025-480x480.jpg` },
  { number: 10, name: "Tyler Boland", position: "Stürmer", nationality: "Kanada", flag: "ca", image: `${IR}/2023/08/Boland_Kachelbild_2025-480x480.jpg` },
  { number: 11, name: "Henrik Törnqvist", position: "Stürmer", nationality: "Schweden", flag: "se", image: `${IR}/2025/08/Toernqvist_Kachelbild_2025-480x480.jpg` },
  { number: 14, name: "Noel Saffran", position: "Stürmer", nationality: "Deutschland", flag: "de", image: `${IR}/2024/08/Safran_Kachelbild_2025-480x480.jpg` },
  { number: 17, name: "Eirik Salsten", position: "Stürmer", nationality: "Norwegen", flag: "no", image: `${IR}/2025/08/Salsten_Kachelbild_2025-480x480.jpg` },
  { number: 18, name: "Eric Cornel", position: "Stürmer", nationality: "Kanada", flag: "ca", image: `${IR}/2021/07/Cornel_Kachelbild_2025-480x480.jpg` },
  { number: 22, name: "Daniel Neumann", position: "Stürmer", nationality: "Deutschland", flag: "de", image: `${IR}/2025/08/Neumann_Kachelbild_2025-480x480.jpg` },
  { number: 27, name: "Christian Thomas", position: "Stürmer", nationality: "Kanada", flag: "ca", image: `${IR}/2025/01/Thomas_Kachelbild_2025-480x480.jpg` },
  { number: 29, name: "Jakub Borzecki", position: "Stürmer", nationality: "Deutschland", flag: "de", image: `${IR}/2025/08/Borzecki_Kachelbild_2025-480x480.jpg` },
  { number: 36, name: "Anthony Camara", position: "Stürmer", nationality: "Kanada", flag: "ca", image: `${IR}/2025/11/Anthony_Camara_Kachelbild_2025-480x480.jpg` },
  { number: 40, name: "Bence Farkas", position: "Stürmer", nationality: "Deutschland", flag: "de", image: `${IR}/2025/08/Farkas_Kachelbild_2025-480x480.jpg` },
  { number: 41, name: "Maximilian Eisenmenger", position: "Stürmer", nationality: "Deutschland", flag: "de", image: `${IR}/2026/01/Max_Eisenmenger_Kachelbild_2025-480x480.jpg` },
  { number: 63, name: "Manuel Alberg", position: "Stürmer", nationality: "Deutschland", flag: "de", image: `${IR}/2024/09/Alberg_Kachelbild_2025-480x480.jpg` },
  { number: 71, name: "Daniel Fischbuch", position: "Stürmer", nationality: "Deutschland", flag: "de", image: `${IR}/2025/08/Fischbusch_Kachelbild_2025-480x480.jpg` },
  { number: 75, name: "Julian Napravnik", position: "Stürmer", nationality: "Deutschland", flag: "de", image: `${IR}/2025/08/Napravnik_Kachelbild_2025-480x480.jpg` },
  { number: 90, name: "Taro Jentzsch", position: "Stürmer", nationality: "Deutschland", flag: "de", image: `${IR}/2023/10/Jentzsch_Kachelbild_2025-480x480.jpg` },
];
