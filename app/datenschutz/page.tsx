    ...
    <>
      ...
      <section className="section">
        <div className="container max-w-3xl">
          <h2 className="text-xl font-black uppercase text-navy mb-4">Datenschutzerklärung</h2>

          <div className="space-y-8 text-sm text-gray-600">
            <div>
              <h3 className="text-lg font-bold text-navy mb-2">1. Datenschutz auf einen Blick</h3>
              <p className="mb-2">
            ...
            <div>
              <h3 className="text-lg font-bold text-navy mb-2">2. Verantwortliche Stelle</h3>
            ...
            <div>
              <h3 className="text-lg font-bold text-navy mb-2">3. Datenerfassung auf unserer Website</h3>
              <h4 className="font-bold text-navy mb-1">Server-Log-Dateien</h4>
              <p className="mb-4">
              ...
              <h4 className="font-bold text-navy mb-1">Kontaktformular</h4>
              <p>
            ...
            <div>
              <h3 className="text-lg font-bold text-navy mb-2">4. Cookies</h3>
              <p>
            ...
            <div>
              <h3 className="text-lg font-bold text-navy mb-2">5. Newsletter</h3>
              <p>
            ...
            <div>
              <h3 className="text-lg font-bold text-navy mb-2">6. Ihre Rechte</h3>
              <p>
            ...
            <div className="bg-navy/5 rounded-2xl p-6">
              <p className="text-gray-500">
                <strong className="text-navy">Stand:</strong> Februar 2026. Diese Datenschutzerklärung wird regelmäßig
