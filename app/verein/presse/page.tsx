        ...
        <div className="container max-w-3xl">
          ...
          <div className="space-y-6 mb-12">
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-6">
              <h3 className="font-bold text-lg uppercase text-primary mb-2">Akkreditierung</h3>
              ...
              <a href="mailto:presse@iserlohn-roosters.de" className="text-primary font-bold text-sm hover:text-accent transition-colors">
            ...
            {/* Downloads */}
            <div className="bg-white border border-gray-200 rounded-2xl p-6">
              <h3 className="font-bold text-lg uppercase text-primary mb-2">Pressematerial</h3>
              <p className="text-gray-500 text-sm mb-4">
              ...
              <Link href="/kontakt" className="text-primary font-bold text-sm hover:text-accent transition-colors">
                Kontakt aufnehmen →
              </Link>
            </div>
            ...
            {/* Ansprechpartner */}
            <div className="bg-white border border-gray-200 rounded-2xl p-6">
              <h3 className="font-bold text-lg uppercase text-primary mb-2">Pressekontakt</h3>
              <div className="text-sm text-gray-600 space-y-1">
                <p className="font-bold text-primary">Iserlohn Roosters — Pressestelle</p>
                <p>Telefon: <a href="tel:+4923719519510" className="text-primary hover:text-accent transition-colors">02371 / 951 95 10</a></p>
          ...
          <div className="bg-primary/5 rounded-2xl p-8 text-center">
            <h3 className="text-xl font-black uppercase text-primary mb-2">Aktuelle Meldungen</h3>
