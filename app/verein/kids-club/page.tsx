    ...
    <>
      ...
      <section className="section">
        <div className="container max-w-3xl">
          <div className="bg-accent/10 border border-accent/30 rounded-2xl p-8 mb-8">
            <h2 className="text-2xl font-black uppercase text-primary mb-4">Was bietet der Kids Club?</h2>
