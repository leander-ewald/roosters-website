    ...
    <>
      ...
      <section className="section">
        <div className="container max-w-3xl">
          ...
          {/* Benefits */}
          <div className="bg-gradient-to-br from-navy to-purple rounded-2xl p-8 text-white mb-12">
          ...
          {/* Open positions */}
          <h3 className="text-xl font-black uppercase text-navy mb-6">Aktuelle Stellenangebote</h3>
          <div className="bg-navy/5 rounded-2xl p-8 text-center mb-8">
