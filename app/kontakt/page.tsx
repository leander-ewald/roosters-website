          ...
          <div className="grid md:grid-cols-5 gap-8">
              ...
              <form className="space-y-4" action="#">
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input id="name" type="text" required className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-primary focus:ring-2 focus:ring-navy/20 outline-none text-sm" placeholder="Max Mustermann" />
                  </div>
                  <div>
                    <label htmlFor="email" className="block text-sm font-medium text-gray-700 mb-1">E-Mail *</label>
                    <input id="email" type="email" required className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-primary focus:ring-2 focus:ring-navy/20 outline-none text-sm" placeholder="max@beispiel.de" />
                  </div>
                </div>
                <div>
                  <label htmlFor="betreff" className="block text-sm font-medium text-gray-700 mb-1">Betreff</label>
                  <input id="betreff" type="text" className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-primary focus:ring-2 focus:ring-navy/20 outline-none text-sm" placeholder="Worum geht es?" />
                </div>
                <div>
                  <label htmlFor="nachricht" className="block text-sm font-medium text-gray-700 mb-1">Nachricht *</label>
                  <textarea id="nachricht" required rows={6} className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-primary focus:ring-2 focus:ring-navy/20 outline-none text-sm resize-none" placeholder="Deine Nachricht..." />
                </div>
            ...
            <div className="md:col-span-2 space-y-6">
              <div className="bg-white border border-gray-200 rounded-2xl p-6">
                <h3 className="font-bold text-lg uppercase text-primary mb-4">Kontaktdaten</h3>
                ...
                <div className="space-y-3">
                  {KONTAKT_INFO.map((k) => (
                    <div key={k.label} className="flex justify-between text-sm">
                      ...
                      {k.href ? (
                        <a href={k.href} className="text-primary font-medium hover:text-accent transition-colors">{k.value}</a>
                      ) : (
