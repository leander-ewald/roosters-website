    ...
    <>
      ...
      <section className="section">
        <div className="container">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto mb-16">
            {PACKAGES.map((pkg, i) => (
              <div key={pkg.name} className={`rounded-2xl p-6 ${i === 2 ? "bg-primary text-white ring-2 ring-gold" : "bg-white border border-gray-200"}`}>
                ...
                <Link href="/kontakt" className={`btn w-full ${i === 2 ? "btn-accent" : "btn-primary"}`}>
                  Kontakt aufnehmen
                </Link>
              </div>
            ))}
          ...
          {/* VIP */}
          <div id="vip" className="bg-gradient-to-br from-primary to-primary-light rounded-2xl p-8 md:p-12 text-white max-w-4xl mx-auto scroll-mt-24">
            ...
            <Link href="/kontakt" className="btn btn-accent">Anfrage stellen</Link>
          </div>
        </div>
      </section>
    </>
